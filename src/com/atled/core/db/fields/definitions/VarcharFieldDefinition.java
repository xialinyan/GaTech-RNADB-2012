...
public class VarcharFieldDefinition extends DatabaseFieldDefinition {
	...
	public VarcharFieldDefinition(String name, String dbFieldName, int fieldLength) {
		super(name, dbFieldName);
		ParameterChecker.notNegative("fieldLength", fieldLength);
		this.fieldLength = fieldLength;
	}
	
	public VarcharFieldDefinition(String name, String dbFieldName, 
